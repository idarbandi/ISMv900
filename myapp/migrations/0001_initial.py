    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer_economic_code', models.CharField(blank=True, max_length=15, null=True, verbose_name='کد اقتصادی خریدار')),
                ('buyer_postcode', models.CharField(blank=True, max_length=10, null=True, verbose_name='کد پستی خریدار')),
                ('buyer_national_id', models.CharField(blank=True, max_length=50, null=True, verbose_name='شناسه ملی خریدار')),
                ('username', models.CharField(blank=True, max_length=255)),
                ('logs', models.TextField(blank=True)),
            ],
            options={
